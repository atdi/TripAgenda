package eu.aagsolutions.tripagenda.adapters
...
/**
 * Created by aurelavramescu on 04.09.17.
 */
class PlaceArrayAdapter(context: Context, resource: Int, private val mBounds: LatLngBounds,
    ...
    inner class PlaceAutocomplete internal constructor(var placeId: String?, var description: CharSequence) {
